...
class LlamaProvider(LLMProvider):
    ...
    def __init__(self, api_key: str, **kwargs):
        ...
        Args:
            ...
            **kwargs: Additional configuration options
                - model: Llama model to use (default: llama-4-scout)
        ...
        self._client = None
        self.base_url = ""
        self.model = kwargs.get('model', 'llama-4-scout')
        self.max_tokens = kwargs.get('max_tokens', 100000)
        self.temperature = kwargs.get('temperature', 0)
        
    @property
    def client(self):
        """Lazy initialization of OpenAI client with Llama endpoint."""
    ...
    def calculate_cost(self, input_tokens: int, output_tokens: int, model: str) -> float:
        """
        Calculate the cost for a Llama request.
        
        Note: Using estimated pricing. Update when actual pricing is available.
        ...
        model_pricing = {
            'RedHatAI/Llama-4-Scout-17B-16E-Instruct-quantized.w4a16': (0.01, 0.01),  # Unknown pricing
            'llama-4-scout': (0.01, 0.01),  # Unknown pricing
            'llama-3.1': (0.01, 0.01),     # Unknown pricing
            'llama-3': (0.01, 0.01),       # Unknown pricing
        }

        # Default pricing if model not found
        input_price, output_price = model_pricing.get(model, (1.00, 4.00))
    ...
    def analyze_security(self, code_changes: str, context: str = "") -> Tuple[Dict, CostInfo]:
        """
        Analyze code changes using Llama 4 Scout.
        ...
        try:
            ...
            context_limit = 100000  # Llama 4 Scout context limit
            ...
            try:
                ...
                print(f"Warning: Failed to parse Llama's response as JSON:\n{content}")
